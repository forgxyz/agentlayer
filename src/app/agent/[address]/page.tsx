    ...
    return (
      <div className="min-h-screen bg-black">
        ...
        <main className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-16 text-center">
          <p className="text-xl text-zinc-400 mb-4">Address not found</p>
          <p className="text-sm text-zinc-600 mb-6">This address has no recorded x402 activity or ERC-8004 registration.</p>
